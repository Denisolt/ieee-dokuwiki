...
$dbopts = parse_url('postgres://fmdlginfuszszd:436fb65fca061945f8fbac9a102a2c4bd930732acfc3cc728de80943bd4ba6f9@ec2-23-23-248-247.compute-1.amazonaws.com:5432/deeb0um8m2dfbb');

$app->register(new Herrera\Pdo\PdoServiceProvider(),
               array(
                   'pdo.dsn' => 'pgsql:dbname='.ltrim($dbopts["deeb0um8m2dfbb"],'/').';host='.$dbopts["ec2-23-23-248-247.compute-1.amazonaws.com"] . ';port=' . $dbopts["5432"],
                   'pdo.username' => $dbopts["fmdlginfuszszd"],
                   'pdo.password' => $dbopts["436fb65fca061945f8fbac9a102a2c4bd930732acfc3cc728de80943bd4ba6f9"]
               )
);
